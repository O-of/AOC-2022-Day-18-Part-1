...
execute if score counter position < max position as @e[type=minecraft:armor_stand] store result entity @s Pos[0] double 0.1 run scoreboard players get x_stand position
execute if score counter position < max position as @e[type=minecraft:armor_stand] store result entity @s Pos[1] double 0.1 run scoreboard players get y_stand position
execute if score counter position < max position as @e[type=minecraft:armor_stand] store result entity @s Pos[2] double 0.1 run scoreboard players get z_stand position
